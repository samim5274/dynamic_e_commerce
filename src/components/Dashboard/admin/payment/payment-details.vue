        ...
        <div class="flex  min-h-[calc(100vh-56px)]">
            ...
            <div class="flex-1 min-w-0">
                <main class="flex-1 min-h-screen min-w-0 bg-gray-50 dark:bg-[#0C1326] px-4 sm:px-6 lg:px-8 py-6">
                    ...
                    <div v-if="details" class="max-w-5xl mx-auto p-4 sm:p-6 lg:p-8 space-y-6">
...
const fetchTransactionDetails = async () => {
    // Safety guard
    if (!transactionId || transactionId === 'undefined' || !userId || userId === 'undefined') {
        console.warn('Aborting fetch: Invalid route parameters detected.', { transactionId, userId });
        return;
    }
