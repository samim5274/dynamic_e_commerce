  ...
  <section class="min-h-screen bg-gradient-to-b from-[#1E4DAB] to-[#0A235D] text-white flex flex-col items-center justify-center p-6 selection:bg-[#FF782D]/20 selection:text-white transition-colors duration-500 font-sans">
    ...
    <div class="w-full max-w-sm flex flex-col items-center">
      ...
      <div class="h-24 w-24 mb-4 bg-slate-100 dark:bg-[#111a3e]/60 dark:bg-slate-50 rounded-[2rem] flex items-center justify-center border border-slate-200 dark:border-white/10 shadow-xl transition-all duration-500 hover:scale-105">
        <img src="/logo/logo.webp" alt="DBMBL" width="300" height="100" fetchpriority="high" class="object-contain drop-shadow-md dark:hidden" />
        <img src="/logo/white-logo.webp" alt="DBMBL" width="300" height="100" fetchpriority="high" class="hidden dark:block w-20 h-20 object-contain drop-shadow-[0_5px_15px_rgba(163,217,33,0.3)]" />
      </div>
        ...
        <div class="flex flex-col items-center mb-10 text-center">
          <div class="mb-6 group">
            <div class="h-24 w-24 bg-slate-100 dark:bg-[#111a3e]/60 dark:to-transparent backdrop-blur-md rounded-[2rem] flex items-center justify-center border border-slate-200 dark:border-white/10 shadow-xl transition-all duration-500 hover:scale-105">
              <img src="/logo/logo.webp" alt="Logo" class="w-16 h-16 object-contain drop-shadow-md dark:hidden" />
              <img src="/logo/white-logo.webp" alt="Logo" class="hidden dark:block w-16 h-16 object-contain drop-shadow-[0_5px_15px_rgba(163,217,33,0.3)]" />
            </div>
          </div>
